...
const ACTION_TYPES_NOT_FOR_SOLO = [
    ACTION_TYPE_PILFERER    ,
    ACTION_TYPE_SOWER       ,
    ACTION_TYPE_CHARMER     ,
    ACTION_TYPE_JEALOUSY    ,
...
const ACTION_STATE_UNLOCKED_ONE_SHOT = 5;//TO be destroyed after use
...
const OPTION_MODE_SOLO_NOLIMIT = 5;
const OPTION_MODE_CHALLENGE = 6;
...
const OPTION_FLOWER_VALUES = [
    ...
    OPTION_FLOWER_NO_LIMIT_UNOFFICIAL,
];
...
const OPTION_SCHEMA_RANDOM_VERTIG = 501;
const OPTION_SCHEMA_RANDOM_MARONNE = 502;
const OPTION_SCHEMA_RANDOM_SIFFLOCHAMP = 503;
const OPTION_SCHEMA_RANDOM_DENTDINE = 504;
const OPTION_SCHEMA_RANDOM_INSPIRACTRICE = 505;
const OPTION_SCHEMA_RANDOM_COMPETITIVE = 506;
const OPTION_SCHEMA_RANDOM_COMPETITIVE_NL = 507;

const OPTION_SCHEMA_UNOFFICIAL_101 = 101;
const OPTION_SCHEMA_UNOFFICIAL_102 = 102;
const OPTION_SCHEMA_UNOFFICIAL_BIKE = 103;
...
const ST_SOLO_CHOICE_SP = 9;

const ST_NEXT_TURN = 10;

const ST_TURN_CENTRAL_A5 = 15;
