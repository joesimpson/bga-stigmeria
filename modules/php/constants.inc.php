...
const ACTION_COST_MIXING = 1;
const ACTION_COST_COMBINATION = 1;
const ACTION_COST_FULGURANCE = 1;
const ACTION_COST_MOVE_DIAGONAL = 1;
const ACTION_COST_CHOREOGRAPHY = 1;
...
const ACTION_COST_REST = 1;
const ACTION_COST_NSNK = 1;
